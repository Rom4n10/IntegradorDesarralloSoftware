# 🧪 Estrategia de Testing - DNA Analyzer

Este proyecto cuenta con una cobertura de código superior al **80%**, verificada automáticamente con JaCoCo durante el build.

## 1. Tests Unitarios (`DnaPatternAnalyzerTest`)
Se probó exhaustivamente la lógica del algoritmo de detección de anomalías de forma aislada.
- **Casos Positivos:** Anomalías horizontales, verticales, diagonales y mixtas.
- **Casos Negativos:** Secuencias normales sin anomalías.
